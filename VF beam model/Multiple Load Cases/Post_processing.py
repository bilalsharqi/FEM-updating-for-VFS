...
plt.plot(grid_coords[0,:] + static_deform[0][0][:], static_deform[0][2][:],'r',label='0 g' )
plt.plot(grid_coords[0,:] + static_deform[1][0][:], static_deform[1][2][:],'b',label='1 g')
plt.plot(grid_coords[0,:] + static_deform[2][0][:], static_deform[2][2][:],'k',label='-2.5 g')
...
# plt.plot(grid_coords[0,:] + static_deform[3][0][:], static_deform[3][2][:])
# plt.plot(grid_coords[0,:] + static_deform[4][0][:], static_deform[4][2][:])
fig.savefig("beam_static.svg",bbox_inches='tight')

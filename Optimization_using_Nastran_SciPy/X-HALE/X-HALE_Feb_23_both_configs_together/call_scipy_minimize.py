...
ref_freq_NASTRAN[0][6] = 1.03
ref_freq_NASTRAN[0][7] = 2.7
# ref_freq_NASTRAN[0][8] = 5.2
ref_freq_NASTRAN[0][9] = 4.5
ref_freq_NASTRAN[0][10] = 6.2
ref_freq_NASTRAN[0][11] = 7.15
ref_freq_NASTRAN[0][12] = 8.10

# values for subcase 2 - here it is the inboard config for X-HALE
ref_freq_NASTRAN[1][6] = 0.95
ref_freq_NASTRAN[1][7] = 2.7
ref_freq_NASTRAN[1][8] = 4.5
# ref_freq_NASTRAN[1][9] = 4.9
ref_freq_NASTRAN[1][10] = 5.9
ref_freq_NASTRAN[1][12] = 7.3
ref_freq_NASTRAN[1][13] = 8.3

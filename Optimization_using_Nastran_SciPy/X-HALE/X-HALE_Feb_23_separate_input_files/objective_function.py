...
def obj_func(x,inp_dir, run_dir, out_dir, ref_file,mistuned_file, M_ref, J_G_ref, x_G_ref, ref_freq_NASTRAN,x_lb,x_ub):
    ...
    mistuned_model.properties[55555].Ki[0] = x_Nastran[12]
    mistuned_model.properties[55555].Ki[1] = x_Nastran[13]
    mistuned_model.properties[55555].Ki[2] = x_Nastran[14]
    mistuned_model.properties[55555].Ki[4] = x_Nastran[15]
    mistuned_model.properties[55555].Ki[5] = x_Nastran[16]

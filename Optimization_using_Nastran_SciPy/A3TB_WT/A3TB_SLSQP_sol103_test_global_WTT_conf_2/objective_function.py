...
def obj_func(x,inp_dir, run_dir, out_dir, ref_file,mistuned_file, M_ref, J_G_ref, x_G_ref, ref_freq_NASTRAN,x_lb,x_ub):
    ...
    mistuned_model.properties[45].Ki[0] = x_Nastran[0][0]
    mistuned_model.properties[45].Ki[1] = x_Nastran[0][1]
    mistuned_model.properties[45].Ki[2] = x_Nastran[0][2]
    mistuned_model.properties[45].Ki[3] = x_Nastran[0][3]
    mistuned_model.properties[45].Ki[4] = x_Nastran[0][4]
    mistuned_model.properties[45].Ki[5] = x_Nastran[0][5]

...
ref_freq_NASTRAN[0][1] = 7.0
ref_freq_NASTRAN[0][2] = 12.00
ref_freq_NASTRAN[0][3] = 15.10
ref_freq_NASTRAN[0][4] = 35.50
...
x = np.array([np.transpose(mistuned_spring)])
...
x_ref = np.array([np.transpose(ref_spring)])

...
ref_freq_NASTRAN[0][0] = 2.32
ref_freq_NASTRAN[0][1] = 6.76
ref_freq_NASTRAN[0][2] = 11.82
ref_freq_NASTRAN[0][3] = 12.94
ref_freq_NASTRAN[0][4] = 30.45
...
mistuned_mass = np.zeros(numMatMassProps-3)
...
mistuned_con_masses = np.zeros(1)
...
mistuned_stiffness[4] = mistuned_model.materials[100001].e
...
mistuned_mass[3] = mistuned_model.materials[100001].rho
...
# manually add shaker mass as design variable
mistuned_con_masses[0] = mistuned_model.masses[1919].mass
...
x = np.append(x,[np.transpose(mistuned_con_masses)])
...
ref_stiffness[4] = ref_model.materials[100001].e
...
ref_mass[3] = ref_model.materials[100001].rho
...
# manually add ref con mass for shaker
ref_con_masses[0] = ref_model.masses[1919].mass
...
x_ref = np.append(x_ref,[np.transpose(ref_con_masses)])
...
bnds_stiffness_1,x_lb_stiffness_1,x_ub_stiffness_1 = bounds_func_single(x_ref[4],0.75,1.25)
bnds_stiffness_2,x_lb_stiffness_2,x_ub_stiffness_2 = bounds_func_single(x_ref[5],0.5,5.0)
bnds_stiffness_3,x_lb_stiffness_3,x_ub_stiffness_3 = bounds_func_single(x_ref[6],0.8,1.2)
bnds_stiffness_4,x_lb_stiffness_4,x_ub_stiffness_4 = bounds_func_single(x_ref[7],0.8,1.2)
bnds_stiffness_5,x_lb_stiffness_5,x_ub_stiffness_5 = bounds_func_single(x_ref[8],0.75,1.25)
bnds_spring_1,x_lb_spring_1,x_ub_spring_1 = bounds_func_single(x_ref[9],0.75,1.5)
bnds_spring_2,x_lb_spring_2,x_ub_spring_2 = bounds_func_single(x_ref[10],0.75,1.5)
bnds_spring_3,x_lb_spring_3,x_ub_spring_3 = bounds_func_single(x_ref[11],0.75,1.5)
bnds_spring_4,x_lb_spring_4,x_ub_spring_4 = bounds_func_single(x_ref[12],0.75,2.0)
bnds_spring_5,x_lb_spring_5,x_ub_spring_5 = bounds_func_single(x_ref[13],0.75,1.5)
bnds_spring_6,x_lb_spring_6,x_ub_spring_6 = bounds_func_single(x_ref[14],0.75,1.5)
bnds_shaker_con_mass,x_lb_shaker_con_mass,x_ub_shaker_con_mass = bounds_func_single(x_ref[15],0.75,1.5)

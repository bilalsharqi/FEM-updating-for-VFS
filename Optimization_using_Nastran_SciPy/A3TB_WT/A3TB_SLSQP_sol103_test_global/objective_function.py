...
def obj_func(x,inp_dir, run_dir, out_dir, ref_file,mistuned_file, M_ref, J_G_ref, x_G_ref, ref_freq_NASTRAN,x_lb,x_ub):
    ...
    # stiffness variables 
    mistuned_model.materials[1].e = x_Nastran[3]
    mistuned_model.materials[2].e = x_Nastran[4]
    mistuned_model.materials[3].e11 = x_Nastran[5]
    mistuned_model.materials[3].e22 = x_Nastran[5]
    mistuned_model.materials[3].g12 = x_Nastran[6]

    # root spring variables 
    mistuned_model.properties[46].Ki[0] = x_Nastran[7]
    mistuned_model.properties[46].Ki[1] = x_Nastran[8]
    mistuned_model.properties[46].Ki[2] = x_Nastran[9]
    mistuned_model.properties[46].Ki[4] = x_Nastran[10]
    mistuned_model.properties[46].Ki[5] = x_Nastran[11]

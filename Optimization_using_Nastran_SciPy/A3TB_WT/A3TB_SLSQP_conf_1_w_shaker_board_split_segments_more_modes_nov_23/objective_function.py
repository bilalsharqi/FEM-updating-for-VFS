...
def obj_func(x,inp_dir, run_dir, out_dir, ref_file,mistuned_file, M_ref, J_G_ref, x_G_ref, ref_freq_NASTRAN,x_lb,x_ub):
    ...
    # density variables 
    mistuned_model.materials[1001].rho = x_Nastran[0]
    mistuned_model.materials[1002].rho = x_Nastran[1]
    mistuned_model.materials[1003].rho = x_Nastran[2]
    mistuned_model.materials[1004].rho = x_Nastran[3]
    mistuned_model.materials[31].rho = x_Nastran[4]
    mistuned_model.materials[32].rho = x_Nastran[5]
    mistuned_model.materials[33].rho = x_Nastran[6]
    mistuned_model.materials[34].rho = x_Nastran[7]
    mistuned_model.materials[4].rho = x_Nastran[8]
    mistuned_model.materials[100001].rho = x_Nastran[9]

    # stiffness variables 
    mistuned_model.materials[1001].e = x_Nastran[10]
    mistuned_model.materials[1002].e = x_Nastran[11]
    mistuned_model.materials[1003].e = x_Nastran[12]
    mistuned_model.materials[1004].e = x_Nastran[13]
    mistuned_model.materials[201].e = x_Nastran[14]
    mistuned_model.materials[202].e = x_Nastran[15]
    mistuned_model.materials[203].e = x_Nastran[16]
    mistuned_model.materials[204].e = x_Nastran[17]
    mistuned_model.materials[31].e11 = x_Nastran[18]
    mistuned_model.materials[31].e22 = x_Nastran[18]
    mistuned_model.materials[31].g12 = x_Nastran[19]
    mistuned_model.materials[32].e11 = x_Nastran[20]
    mistuned_model.materials[32].e22 = x_Nastran[20]
    mistuned_model.materials[32].g12 = x_Nastran[21]
    mistuned_model.materials[33].e11 = x_Nastran[22]
    mistuned_model.materials[33].e22 = x_Nastran[22]
    mistuned_model.materials[33].g12 = x_Nastran[23]
    mistuned_model.materials[34].e11 = x_Nastran[24]
    mistuned_model.materials[34].e22 = x_Nastran[24]
    mistuned_model.materials[34].g12 = x_Nastran[25]
    mistuned_model.materials[100001].e = x_Nastran[26]

    # root spring variables 
    mistuned_model.properties[45].Ki[0] = x_Nastran[27]
    mistuned_model.properties[45].Ki[1] = x_Nastran[28]
    mistuned_model.properties[45].Ki[2] = x_Nastran[29]
    mistuned_model.properties[45].Ki[3] = x_Nastran[30]
    mistuned_model.properties[45].Ki[4] = x_Nastran[31]
    mistuned_model.properties[45].Ki[5] = x_Nastran[32]
    ...
    for i in range(len(ref_freq_NASTRAN)):
        for j in range(len(ref_freq_NASTRAN[0])-8):
            if (j == 0):

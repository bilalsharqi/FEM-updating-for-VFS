...
file_path = temp_path + 'reference/Renumbered_grids'
f06_file = 'sol400.f06'
...
# Note: There are 4 loading subcases and 15 eigenvalues computed for each
# deformed modal analysis
file_path = temp_path + 'initial/Renumbered_grids'
...
# Note: There are 4 loading subcases and 15 eigenvalues computed for each
# deformed modal analysis
file_path = temp_path + 'intermediate/Renumbered_grids'
f06_file = 'mistuned_sol400.f06'
model_coords = 'mistuned_sol400_coor.txt'
...
# path = os.path.join(dir, "mistuned_mode_shapes_data_wingbox.mat")
# database = {}
...
# ax.set_box_aspect((np.ptp(ref_grid_coords[0,:] + ref_static_deform[subcase][0]), 3*np.ptp(ref_grid_coords[1,:] + ref_static_deform[subcase][1]), np.ptp(ref_grid_coords[2,:] + ref_static_deform[subcase][2])))
